...
export default class ObsidianFlashcard extends Plugin {
	...
	private getDefaultSettings(): ISettings {
		return { contextAwareMode: true, sourceSupport: true, codeHighlightSupport: true, contextSeparator: " > ", deck: "Default", folderBasedDeck: true, folder: "", flashcardsTag: "card", inlineSeparator: "::", inlineSeparatorReverse: ":::", defaultAnkiTag: "obsidian", ankiConnectPermission: false }
	}
